 ...
 * @returns {*}
 */
PostmanEwkollReporter = function (newman, options, collectionRunOptions) {
    ...
    newman.on('beforeDone', function () {
        ...
        this.exports.push({
            name: 'html-reporter-ewkoll',
            default: (this.summary.collection.name).match(pattern) ?
                `${this.summary.collection.name}.html` : 'newman_ewkoll.html',
            path: options.export,
            content: compiler({
...
module.exports = PostmanEwkollReporter;